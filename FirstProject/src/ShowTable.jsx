                ...
                {Show && sendData.map((e)=>{
                    ...
                    return(
                        <div className="Tb-row" key={e.key}>
                            <div className="Tb-col col1" style={{borderLeft:"solid 2px rgba(0,0,0,0.7)"}}>{e.key}</div>
                            <div className="Tb-col col2" >{e.model}</div>
                            <div className="Tb-col col3">{e.error}</div>
                            <div className="Tb-col col4">{e.price}</div>
                            <div className="Tb-col col5"  style={e.price>e.source ? {borderRight:"solid 2px green"}: {borderRight:"solid 2px red"}}>{e.source}</div>
                        </div>
                    )
                })}
